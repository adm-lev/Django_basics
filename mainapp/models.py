...
class News(models.Model):
    ...
    created = models.DateTimeField(auto_now=True, verbose_name='Created', editable=True)
    updated = models.DateTimeField(auto_now=True, verbose_name='Edited', editable=True)
...
class Lesson(models.Model):
    ...
    num = models.PositiveIntegerField(verbose_name='Lessons number')
...
class CourseFeedback(models.Model):
    ...
    feedback = models.TextField(default=_("No_feedback"), verbose_name=_('Feedback'))
